...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ot8efco.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ot8efco.containers.anotherwebservice.com/
...
```
git clone git@github.com:alijbareen/container-ot8efco.git
cd container-ot8efco
```
...
```
docker attach container-ot8efco
```
